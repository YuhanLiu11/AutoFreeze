...
def write_data(indices, data_queue, epoch, args, evt, length):
    """Write data generated from the current epoch to disk and set index_dict.
    param:
        index_dict: If a point with 'index' in the original dataset is written to disk, put index as a key in dictionary, and set value to False
    """
...
def read_data(train_indices, new_cached_queue, epoch,args, evt, loading_x, length, evict):
    ...
    args: loading_x is the index of the file
    """
